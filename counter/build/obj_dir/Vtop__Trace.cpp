...
void Vtop___024root__traceChgSub0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->chgCData(oldp+11,(vlSelf->clk_1s),6);
        tracep->chgCData(oldp+12,(vlSelf->seg0),8);
        tracep->chgCData(oldp+13,(vlSelf->seg1),8);
        tracep->chgIData(oldp+14,(vlSelf->top__DOT__count_clk),26);
    }
}

...
void Vtop___024root__traceInitSub0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+5,"led", false,-1);
        tracep->declBit(c+1,"top a", false,-1);
        tracep->declBit(c+2,"top b", false,-1);
        tracep->declBit(c+3,"top clk", false,-1);
        tracep->declBit(c+4,"top rst", false,-1);
        tracep->declBit(c+5,"top led", false,-1);
    }
}
...
void Vtop___024root__traceFullSub0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullBit(oldp+4,(vlSelf->rst));
        tracep->fullBit(oldp+5,(vlSelf->led));
    }
}
